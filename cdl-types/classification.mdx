...
<CardGroup cols={3}>
  <Card
    ...
    href="class-a-cdl"
  >
    Learn the requirements and process to obtain a Class A CDL, allowing you to operate large commercial trucks.
  </Card>
  <Card
    title="CDL Class B"
    icon="bus"
    href="class-b-cdl"
  >
    Discover how to get your Class B CDL to drive straight trucks, large passenger buses, and segmented buses.
  </Card>
  <Card
    title="CDL Class C"
    icon="exchange-alt"
    href="cdl-class-a-b-upgrade"
  >
    Upgrade from a Class B to a Class A CDL for expanded driving opportunities and higher capacity vehicles.
  </Card>
  <Card
    title="HazMat Endorsement"
    icon="biohazard"
    href="hazmat-endorsement"
  >
    Understand the steps to earn your HazMat endorsement for transporting hazardous materials.
  </Card>
  <Card
    title="Passenger Endorsement"
    icon="users"
    href="passenger-endorsement"
  >
  ...
  <Card
    ...
    icon="school"
    href="school-bus-endorsement"
  >
    Find out the process for the School Bus endorsement to drive school buses and ensure student safety.
  </Card>
</CardGroup>
