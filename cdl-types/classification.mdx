...
description: 'A commercial driver's license (CDL) is a driver's license required to operate large, heavy, or placarded hazardous material vehicles in the United States in commerce.'
icon: 'id-card'
sidebarTitle: "CDL classification"
---

There are several different types of commercial motor vehicles (CMVs) that require a driver to hold a valid commercial driver's license.
